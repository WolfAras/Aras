			...
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						<div class='landing-ico-logo'>  <!-- ikonka -->
						</div>
						<div class='landing-tx1-heading pulsate'>
							<h1>Мы разрабатываем игры эксперименты, пытаемся повторить популярные механики или просто получить опыт.<br>
							<!-- PlayStation 3 Emulator</h1>-->
						</div>
						<div class='landing-tx2-heading'>
							<p>
							<!--<h1>Мы разрабатываем игры эксперименты, пытаемся повторить популярные механики или просто получить опыт.-->
							</p>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
								Мы всегда открыты для того, чтобы позволить игрокам высылать предложения для улучшения игр. Игры представляют собой сложные части программного обеспечения и, как таковые, имеют множество подкомпонентов, требующих особого внимания и организации. С вашей помощью вы можете внести свой вклад в вывод игр на новый уровень.
